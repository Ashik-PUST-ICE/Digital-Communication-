...
# Input binary sequence from the user without spaces
binary_sequence = input("Enter the binary sequence without spaces (e.g., 010101): ").replace(" ", "")
binary_sequence = [int(bit) for bit in binary_sequence]  # Convert input string to list of integers

# Display binary data
print("Binary Information at transmitter:")
print(binary_sequence)

x = np.array(binary_sequence)
bp = 0.000001
